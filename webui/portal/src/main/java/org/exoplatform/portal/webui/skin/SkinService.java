...
public class SkinService {
	...
	public void addSkin(String module,String skinName,String cssPath,boolean isPrimary,String css) {
		availableSkins_.add(skinName);
		String key = module + "$" + skinName;		
		skinConfigs_.put(key, new SkinConfig(module, skinName, cssPath, isPrimary));		
		mergedCSS_.put(cssPath,css);					
	}	
