  ...
  static public class AddApplicationActionListener extends EventListener<UIAddNewApplication> {
    ...
    public void addApplicationToPage(Event<UIAddNewApplication> event) throws Exception {
      ...
      if (org.exoplatform.web.application.Application.EXO_PORTLET_TYPE.equals(application.getApplicationType())) {
        ...
        windowId.append(":/").append(application.getApplicationGroup() + "/"
            + application.getApplicationName()).append('/').append(uiPortlet.hashCode());
        ...
        // } else if
        // (org.exoplatform.web.application.Application.EXO_WIDGET_TYPE.equals(application
        // .getApplicationType())) {
        // UIWidget uiWidget =
        // uiPage.createUIComponent(event.getRequestContext(), UIWidget.class,
        // null, null);
        //
        // StringBuilder windowId = new
        // StringBuilder(Util.getUIPortal().getOwner());
        // windowId.append(":/").append(application.getApplicationGroup() + "/"
        // +
        // application.getApplicationName()).append('/').append(uiWidget.hashCode());
        ...
        // uiWidget.getProperties().put(UIApplication.locationX,
        // String.valueOf(posX));
        // uiWidget.getProperties().put(UIApplication.locationY,
        // String.valueOf(posY));
        //
        // uiPage.addChild(uiWidget);
        // //TODO: dang.tung -- add new gadget
      } else if (org.exoplatform.web.application.Application.EXO_GAGGET_TYPE.equals(application.getApplicationType())) {
        ...
        windowId.append(":/").append(application.getApplicationGroup() + "/"
            + application.getApplicationName()).append('/').append(uiGadget.hashCode());
