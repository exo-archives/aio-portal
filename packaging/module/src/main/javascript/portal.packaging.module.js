...
//  	addDependency(ws.frameworks.cometd).
  ...
  module.sample.portlets = 
    new Project("org.exoplatform.portal", "exo.portal.sample.portlets", "war", module.version);
  module.sample.portlets.deployName = "eXoSamplePortlets" ;
