/**
 * This class is used to deplay a content as if notification
 * Constructor will create some default information as slide time, number of message ...
 * And other neccessary variables
 * @return
 */
