Summary
    ...
    * Status: Problem in drag and drop containers and portlets when editing page
    * CCP Issue: CCP-391, Product Jira Issue : PORTAL-3787
    * Complexity: LOW
...
Patches files:
* File PORTAL3787-20100531.patch
